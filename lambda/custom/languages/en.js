...
module.exports = {
  translation: {
    ...
    GET_DESCRIPTION_SPEECH: '%s is the %sth state, admitted to the Union in %s.  The capital of %s is %s, and the abbreviation for %s is <break strength=\'strong\'/><say-as interpret-as=\'spell-out\'>%s</say-as>.  I\'ve added %s to your Alexa app. ',
    GET_DESCRIPTION_REPROMPT: ' Which other state or capital would you like to know about?',
    ...
    CARD_TITLE: 'United States Quiz Game!',
